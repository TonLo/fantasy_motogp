...
class RaceDates {
  ...
  final australianRaceWeek = DateTimeRange(
    start: DateTime(2022, 10, 13),
    end: DateTime(2022, 10, 17),
  );

  final malaysianRaceWeek = DateTimeRange(
    start: DateTime(2022, 10, 20),
    end: DateTime(2022, 10, 24),
  );

  final valenciaRaceWeek = DateTimeRange(

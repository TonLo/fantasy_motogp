...
class TwelfthPick extends StatelessWidget {
  static const int _gridPosition = 11;
          ...
          child: Consumer<GridProvider>(
            builder: (context, _consumerGridProvider, child) {
              return Container(
                width: 100,
                height: 100,
                child: _consumerGridProvider.twelfthPlaceGridRider.image == null
                    ? Image.asset(_emptyImage)
                    : Image.asset(
                        _consumerGridProvider.twelfthPlaceGridRider.image,
                      ),
              );
            },
          ),

...
class FifthPick extends StatelessWidget {
  static const int _gridPosition = 4;
          ...
          child: Consumer<GridProvider>(
            builder: (context, _consumerGridProvider, child) {
              return Container(
                width: 100,
                height: 100,
                child: _consumerGridProvider.fifthPlaceGridRider.image == null
                    ? Image.asset(_emptyImage)
                    : Image.asset(
                        _consumerGridProvider.fifthPlaceGridRider.image,
                      ),
              );
            },
          ),

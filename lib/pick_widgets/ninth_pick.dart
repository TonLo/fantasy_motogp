...
class NinthPick extends StatelessWidget {
  static const int _gridPosition = 8;
          ...
          child: Consumer<GridProvider>(
            builder: (context, _consumerGridProvider, child) {
              return Container(
                width: 100,
                height: 100,
                child: _consumerGridProvider.ninthPlaceGridRider.image == null
                    ? Image.asset(_emptyImage)
                    : Image.asset(
                        _consumerGridProvider.ninthPlaceGridRider.image,
                      ),
              );
            },
          ),

...
class TenthPick extends StatefulWidget {
  @override
  _TenthPickState createState() => _TenthPickState();
}

class _TenthPickState extends State<TenthPick> {
  int currentPick = 9;
  @override
      ...
      child: GestureDetector(
        child: Card(
          ...
          child: Container(
            ...
            child: Image.asset(rider.riderVar.tenthPickImage),
          ),
        ),
        onTap: () {
